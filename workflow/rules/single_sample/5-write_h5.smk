...
rule step5_prev_filter_h5:
    # filter H5 by mutational prevalence and base-quality artifact prevalence
    input:
...
rule step5_write_h5_from_m2_f_vcf_and_rc:
    ...
    resources:
        ...
        time_min = 59
    script:
        os.path.join(scripts_dir, "single_sample/STEP5-write_h5_from_combined-vcf_and_rc.py")