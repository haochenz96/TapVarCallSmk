...
# --- fetch from conig
insert_file = snakemake.config['reference_info']['panel_insert_file_UCSC'] # this need to be UCSC format ('chr1' instead of '1')
...
logging.info(f'--- [STEP5] starting to write to output file: {output_h5}')
...
logging.info('--- [STEP5] created DNA assay.')
# add cell_num_index
...
logging.info('--- [STEP5] renamed dna.row_attrs["barcode"] to numerical indices.')
...
logging.info(f'--- [STEP5] added amplicon metadata from: {amplicons_file}')
...
logging.info(f'--- [STEP5] finished adding DNA, CNV assays to output H5 file.')
